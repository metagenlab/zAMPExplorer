  ...
  shinydashboard::dashboardPage(
    ...
    shinydashboard::dashboardSidebar(
      shinydashboard::sidebarMenu(
        ...
        shinydashboard::menuItem("Heatmap", tabName = "heatmap", icon = icon("th-large")),
        ...
        shinydashboard::menuItem("Differential Abundance", tabName = "differentialAbundance", icon = icon("chart-pie")),
            ...
            box(
              ...
              tabsetPanel(
                ...
                tabPanel(
                  ...
                  DTOutput("maaslin2_results") # Display results in a DataTable
                )
              ) # Close tabsetPanel
            ) # Close box
          ) # Close fluidRow
