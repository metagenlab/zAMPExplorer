...
shinyUI(
  dashboardPage(
    ...
    dashboardBody(
      ...
      tabItems(
        # Tab for uploading phyloseq objects (both rarified and non-rarified)
        tabItem(tabName = "upload",
                fluidRow(
                  box(title = "Upload Non-Rarified Phyloseq Object", width = 12, status = "primary",
                      fileInput("nonRarifiedPhyseqFile", "Choose Non-Rarified RDS File", accept = c(".rds")),
                      helpText("Upload the non-rarified phyloseq object.")
                  ),
                  box(title = "Upload Rarified Phyloseq Object", width = 12, status = "primary",
                      fileInput("rarifiedPhyseqFile", "Choose Rarified RDS File (Optional)", accept = c(".rds")),
                      helpText("You can optionally upload a rarified phyloseq object if available.")
                  ),
                  box(title = "Select Phyloseq Object for Analysis", width = 12, status = "primary",
                      radioButtons("physeqChoice", "Choose Phyloseq Object to Use:",
                                   choices = list("Non-Rarified" = "nonRarified",
                                                  "Rarified" = "rarified"),
                                   selected = "nonRarified")
                  )
                )
        ),
        ...
        # UI for the phylogenetic tree plot
        ...
        tabItem(tabName = "readsQC",
                ...
                fluidRow(
                  uiOutput("reads_qc_content")  # Placeholder for dynamically showing Reads QC content
                ),
                fluidRow(
                  uiOutput("rarefaction_ui")  # Placeholder for dynamically showing Rarefaction Plot
                )
        ),
        ...
        tabItem(tabName = "taxaoverview",
                fluidRow(
                  box(title = "Taxa Overview", width = 12, status = "primary",
                      # Buttons for various taxa-related plots and explanations
                      ...
                      actionButton("explain_dominant_taxa_groups", label = NULL, icon = icon("info-circle"),
                                   class = "btn-info", style = "color: #fff; background-color: #007bff; border-color: #007bff;"),
                      ...
                      actionButton("explain_dominant_taxa_samples", label = NULL, icon = icon("info-circle"),
                                   class = "btn-info", style = "color: #fff; background-color: #007bff; border-color: #007bff;"),
                      # Buttons for additional taxa plots
                      ...
                      actionButton("explain_venn_diagram_plot", label = NULL, icon = icon("info-circle"),
                                   class = "btn-info", style = "color: #fff; background-color: #007bff; border-color: #007bff;"),
                      actionButton("show_sunburst_plot", "Sunburst Plot"),
                      actionButton("explain_sunburst_plot", label = NULL, icon = icon("info-circle"),
                                   class = "btn-info", style = "color: #fff; background-color: #007bff; border-color: #007bff;"),

                  )
                ),
                fluidRow(
                  uiOutput("taxa_overview_content")  # Placeholder for dynamically showing taxa overview content
                )
        ),
