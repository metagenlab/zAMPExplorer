...
# Install microViz Dependency

# Since microViz is not on CRAN, install it from R-universe:
...
\#Method 1 : You can install the development version of zAMPExplorer
like so:

``` r
install.packages("devtools") # If not already installed
#> Installing package into '/private/var/folders/xs/1s58n__s7038wg03tpt62jm00000gn/T/RtmpnAS0g3/temp_libpathd35a28874715'
#> (as 'lib' is unspecified)
#> 
#> The downloaded binary packages are in
#>  /var/folders/xs/1s58n__s7038wg03tpt62jm00000gn/T//Rtmp60ksNn/downloaded_packages

devtools::install_github("https://github.com/metagenlab/zAMPExplorer")
#> Downloading GitHub repo metagenlab/zAMPExplorer@HEAD
#> Skipping 25 packages ahead of CRAN: BiocGenerics, zlibbioc, GenomeInfoDbData, GenomeInfoDb, XVector, IRanges, S4Vectors, rhdf5filters, Rhdf5lib, rhdf5, treeio, ggtree, DelayedArray, S4Arrays, GenomicRanges, MatrixGenerics, multtest, Biostrings, biomformat, ggtreeExtra, SummarizedExperiment, phyloseq, ComplexHeatmap, microbiome, InteractiveComplexHeatmap
#> ── R CMD build ─────────────────────────────────────────────────────────────────
#> * checking for file ‘/private/var/folders/xs/1s58n__s7038wg03tpt62jm00000gn/T/Rtmp60ksNn/remotesd98878be989d/metagenlab-zAMPExplorer-e2e28ce/DESCRIPTION’ ... OK
...
#> Installing package into '/private/var/folders/xs/1s58n__s7038wg03tpt62jm00000gn/T/RtmpnAS0g3/temp_libpathd35a28874715'
#> (as 'lib' is unspecified)
#> Warning in install.packages("path/to/zAMPExplorer_0.1.0.tar.gz", repos = NULL,
#> : installation of package 'path/to/zAMPExplorer_0.1.0.tar.gz' had non-zero exit
#> status
```
